...
<head>
    ...
    <title>VCV - Agência de Viagens</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../dashboard/">VCV - Agência de Viagens</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li>
                    <i class="fa fa-user fa-fw"></i> &nbsp;&nbsp;Bem vindo
                </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="../pacotes/"><i class="fa fa-plane fa-fw"></i>Pacotes</a>
                        </li>
                        ...
                        <li>
                            <a href="../usuarios/"><i class="fa fa-cogs fa-fw"></i> Usuários</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
